      ...
      <div className="flex justify-center  flex-wrap flex-row h-full w-full bg-white ">
        <div className="flex justify-center items-center md:w-full xl:w-9/12 bg-white md:mx-auto  flex-col ">
          ...
          <div className="w-4/5  bg-white">
            <h1 className="text-black-200 text-2xl">Aksi Bersama</h1>
            <p className="text-black">
            Event ini, berjudul Aksi Bersama: Mengatasi Krisis Limbah Plastik dalam Upaya Konservasi Lingkungan, menawarkan kesempatan kepada masyarakat untuk bersatu dalam menangani masalah serius limbah plastik. Melalui berbagai kegiatan, seperti diskusi panel, lokakarya praktis, dan presentasi ahli, peserta akan mendapatkan pemahaman mendalam tentang dampak limbah plastik terhadap lingkungan. Selain itu, event ini juga akan membahas akar penyebab krisis limbah plastik dan mengajak peserta untuk merancang rencana aksi konkrit dalam kehidupan sehari-hari, mulai dari mengurangi penggunaan plastik hingga mendukung program daur ulang. Melalui eksplorasi teknologi dan inovasi terbaru, serta fokus pada solusi berkelanjutan, seperti daur ulang kreatif dan kampanye kesadaran masyarakat, event ini bertujuan untuk menginspirasi aksi bersama yang kuat dalam menjaga keberlanjutan lingkungan untuk generasi mendatang. </p>
          </div>
